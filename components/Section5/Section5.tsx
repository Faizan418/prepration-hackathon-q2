      ...
      <div className={styles.grid}>
        ...
        <div className={styles.main_box}>
            <div className={styles.img_div}>
              <Image className={styles.img} src={'/images/file-five/BreedDryDogFood.png'} alt='item' width={140} height={100}/>
            </div>    
        ...
        <div className={styles.main_box}>
          <div className={styles.img_div}>
            <Image className={styles.img} src={'/images/file-five/CanonEosDslrCamera.png'} alt='item' width={140} height={100}/>
          </div>
          <div className={styles.desc_box}>
        ...
        <div className={styles.main_box}>
          <div className={styles.img_div}>
            <Image className={styles.img} src={'/images/file-five/AsusFhdGamingLaptop.png'} alt='item' width={140} height={100}/>
          </div>
          <div className={styles.desc_box}>
        ...
        <div className={styles.main_box}>
            <div className={styles.img_div}>
              <Image className={styles.img} src={'/images/file-five/KidsElectricCar.png'} alt='item' width={140} height={100}/>
            </div>    
          <div className={styles.desc_box}>
        ...
        <div className={styles.main_box}>
          <div className={styles.img_div}>
            <Image className={styles.img} src={'/images/file-five/Jr.ZoomSoccerCleats.png'} alt='item' width={140} height={100}/>
          </div>
          <div className={styles.desc_box}>
            <h2 className={styles.product_name}>Jr.Zoom Soccer Cleats</h2>
            <p className={styles.product_price}>$1160 <span className={styles.line_throd}>$1160</span></p>
            <span className={styles.product_rating}>
              <FaStar /><FaStar /><FaStar /><FaStar /><FaStar />
              <p className='text-slate-100'> (35)</p>
            </span>
        ...
        <div className={styles.main_box}>
          <div className={styles.img_div}>
            <Image className={styles.img} src={'/images/file-five/GP11ShooterUsbGamepad.png'} alt='item' width={140} height={100}/>
          </div>
          <div className={styles.desc_box}>
        ...
        <div className={styles.main_box}>
          <div className={styles.img_div}>
            <Image className={styles.img} src={'/images/file-five/QuiltedSatinJacket.png'} alt='item' width={140} height={100}/>
          </div>
          <div className={styles.desc_box}>
