      ...
      <div className={styles.first}>
        ...
        <div className={styles.div_two}>
          <div className={styles.extra_headings}>
            <span className={styles.heading_one}>
              Summer Sale For All
              <span className={styles.extra}>
                {" "}
                Swim Suits And Free Express Delivery{" "}
              </span>
              - OFF 50%!{" "}
            </span>
            <span className={styles.heading_two}>
        ...
        <div className={styles.containar}>
          <div className={styles.second}>
            ...
            <div className={styles.div_twotwo}>
              <ul
                className={`${styles.ul_div} ${
                  menuVisible ? styles.show_menu : ""
                }`}
              >
                <li className={styles.div_li}>
                  <Link href={"/"}>Home</Link>
                </li>
                <li className={styles.div_li}>
              ...
              <div className={styles.other_div}>
                <div className={styles.inpt_div}>
                  ...
                  />
                  <CiSearch className="text-3xl p-1 text-black" />
                </div>
